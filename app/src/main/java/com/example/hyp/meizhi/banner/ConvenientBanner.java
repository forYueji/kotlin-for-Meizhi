...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    private void init(Context context) {
        View hView = LayoutInflater.from(context).inflate(
                R.layout.banner_layout_view, this, true);
        viewPager = (CBLoopViewPager) hView.findViewById(R.id.banner_view_pager);
        loPageTurningPoint = (ViewGroup) hView
                .findViewById(R.id.linerlayou_page_turning_point);
        initViewPagerScroll();
    ...
    public ConvenientBanner setPages(CBViewHolderCreator holderCreator, List<T> datas) {
        this.mData = datas;
        pageAdapter = new CBPageAdapter(holderCreator, mData);
    ...
    public ConvenientBanner setTurning(boolean val) {
        viewPager.setCanScroll(val);
        turning = val;
        return this;
    }
     ...
     * 监听item点击
     *
     * @param onItemClickListener 已废弃
     */
    @Deprecated
    private ConvenientBanner setOnItemClickListener(OnItemClickListener onItemClickListener) {
